        ...
        <div className="max-w-7xl mx-auto text-center md:text-left">
          ...
          <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mx-6">
            <div className="text-left">
              <h6 className="text-lg font-semibold text-g-gray-8 mb-3">About</h6>
              <p className="mb-2">
                <a
            ...
            <div className="text-left w-fit">
              <h6 className="text-lg font-semibold text-g-gray-8 mb-3">Resources</h6>
              <p className="mb-2">
                <a
            ...
            <div className="text-left w-fit">
              <h6 className="text-lg font-semibold text-g-gray-8 mb-3 flex justify-left">
                Contact
              </h6>
